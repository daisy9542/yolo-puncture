...
ROOT_DIR = 'resources/datasets/needle-seg-full/panomasks'
TARGET_DIR = 'resources/datasets/needle-seg-full/panomasksRGB'
with open('resources/datasets/needle-seg-full/panoVIPSeg_categories.json', 'r') as f:
    CATEGORIES = json.load(f)
    
original_format_folder = ROOT_DIR
# folder to store panoptic PNGs
out_folder = os.path.join(TARGET_DIR)
out_file = os.path.join('resources/datasets/needle-seg-full/', 'panoptic_gt_VIPSeg.json')
