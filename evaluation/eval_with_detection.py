...
from evaluation.needle_seg_reader import NeedleSegVideoReader, NeedleSegDetectionTestDataset
...
def main():
    ...
    parser.add_argument('--dataset', default='needleseg', help='')
    ...
    assert dataset_name in ['vipseg', 'burst', 'unsup_davis17',
                            'demo', 'needleseg'], f'Unknown dataset {dataset_name}'
    print(f'Dataset: {dataset_name}')
    is_needleseg = (dataset_name == 'needleseg')
    is_vipseg = (dataset_name == 'vipseg')
    is_burst = (dataset_name == 'burst')
    is_davis = (dataset_name == 'unsup_davis17')
    is_demo = (dataset_name == 'demo')

    meta_dataset = NeedleSegDetectionTestDataset(root_dir=args.img_path, split="test")
